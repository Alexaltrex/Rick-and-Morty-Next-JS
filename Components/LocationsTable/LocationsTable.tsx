...
import {ILocationsResponse} from "../../types/locations.types";
...
export const LocationsTable: FC<ILocationsTable> = ({data}) => {
    const rows: IData[] = data.results.map(({id, name, dimension, type}) => ({
        id,
        name,
        dimension,
        type
